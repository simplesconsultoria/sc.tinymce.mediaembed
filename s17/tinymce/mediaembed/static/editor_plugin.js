...
(function() {
	...
	tinymce.create('tinymce.plugins.MediaEmbedPlugin', {
		...
		init : function(ed, url) {
			...
			// Register mediaembed button
			ed.addButton('mediaembed', {
				title : 'mediaembed.desc',
				cmd : 'mceMediaEmbed',
				image : url + '/img/embeb.png'
			});
	...
	// Register plugin
	tinymce.PluginManager.add('mediaembed', tinymce.plugins.MediaEmbedPlugin);
})();
